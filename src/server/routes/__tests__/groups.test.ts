...
describe("PUT /groups/reorder", () => {
  ...
  it("calls reorderGroups and returns 204", async () => {
    ...
    expect(mockGroupService.reorderGroups).toHaveBeenCalledWith("user-1", [
      "00000000-0000-0000-0000-000000000001",
      "00000000-0000-0000-0000-000000000002",
    ]);
  });
...
describe("PUT /groups/:id", () => {
  ...
  it("renames a group", async () => {
    mockGroupService.renameGroup.mockResolvedValue({
      ...GROUP,
      name: "Renamed",
    });
    const app = await buildApp();
  ...
  it("returns 404 when group not found", async () => {
    mockGroupService.renameGroup.mockRejectedValue(
